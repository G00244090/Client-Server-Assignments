...
public class Main extends JFrame implements ActionListener, ChangeListener {
	...
	public Main() throws Exception {
		...
		StatsPanel listPanel = new StatsPanel("List", new String[] { "ArrayList", "CopyOnWriteArray", "Stack" });
		...
		StatsPanel setPanel = new StatsPanel("Set", new String[] { "LinkedHash", "ConcurrentSkipList", "TreeSet" });
		...
		StatsPanel mapPanel = new StatsPanel("Map", new String[] { "WeakHash", "ConcurrentHash", "Identity", "ConcurrentSkipList" });
